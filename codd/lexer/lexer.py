...
class Lexer:
    ...
    def _next_token(self) -> Token:
        ...
        if ch == "/" and ch2 == "^":
            self._advance()
            self._advance()
            return self._make_token(TokenType.SLASH_CARET, "/^", line, col)
        if ch == "/" and ch2 == ">":
            self._advance()
            self._advance()
            return self._make_token(TokenType.SLASH_GT, "/>", line, col)
        if ch == "/" and ch2 == "&":
            self._advance()
            self._advance()
            return self._make_token(TokenType.SLASH_AMP, "/&", line, col)
        ...
        if ch == "#" and ch2 == "!":
            self._advance()
            self._advance()
            return self._make_token(TokenType.HASH_BANG, "#!", line, col)
        if ch == "#" and ch2 == ".":
            self._advance()
            self._advance()
        ...
        if ch == "." and ch2 == "a" and self._peek(2) == "s" and not (self._peek(3).isalnum() or self._peek(3) == "_"):
            self._advance()
            self._advance()
            self._advance()  # consume .as (3 chars)
            return self._make_token(TokenType.AS_DOT, ".as", line, col)
